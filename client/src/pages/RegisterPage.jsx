...
export default function RegisterPage() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      toast({ title: 'Account created', description: 'Welcome to the platform.', variant: 'success' });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Start generating videos with AI in minutes.</CardDescription>
      </CardHeader>
      <CardContent>
