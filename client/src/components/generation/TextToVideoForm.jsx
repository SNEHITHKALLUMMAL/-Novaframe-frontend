  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); mutation.mutate(); }} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        />
        <p className="text-xs text-muted-foreground">Be descriptive for best results — include camera movement, lighting, and style.</p>
      </div>
      <div className="space-y-1.5">
        <Label htmlFor="t2v-duration">Duration</Label>
        <Select
          id="t2v-duration"
          value={duration}
      ...
      <Button type="submit" isLoading={mutation.isPending} disabled={!prompt.trim() || !selectedModelId} className="w-full">
